        ...
        <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="max-w-xl mx-auto text-center">
            ...
            >
              ...
              <button
                type="submit"
                className="h-11 px-5 bg-gold text-background text-sm font-medium tracking-wide rounded-sm hover:bg-gold-light transition-colors flex items-center justify-center gap-2 shrink-0 min-h-[44px]"
              >
                Subscribe
