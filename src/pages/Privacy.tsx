    ...
    <SiteLayout>
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="font-display text-3xl lg:text-4xl font-medium tracking-tight mb-2">Privacy Policy</h1>
          <p className="text-xs text-muted-foreground mb-8">Last updated: August 2026</p>
          <p className="text-[11px] text-gold/60 mb-8 italic">[Replace with legally reviewed policy before launch.]</p>
